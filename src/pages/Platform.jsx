    ...
    >
      ...
      {i === 1 ? (
        ...
        <div className="platform-video-collage">
            ...
            src={assetPath('/assets/platform/mod2.mp4')}
            muted
            autoPlay
            loop
            playsInline
            ...
            <video
            className="platform-video-row"
            src={assetPath('/assets/platform/mod3.mp4')}
            muted
            autoPlay
            loop
            playsInline
